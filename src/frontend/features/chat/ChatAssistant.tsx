        ...
        <div className="grid lg:grid-cols-5 gap-12 items-center">
          ...
          <div className="lg:col-span-3">
            <div className="bg-[#0a0a0a] rounded-[2.5rem] shadow-2xl border border-white/10 flex flex-col h-[600px] overflow-hidden transition-colors">
              {/* Header */}
              <div className="p-4 border-b border-white/10 flex items-center justify-between bg-[#0a0a0a] z-10 shadow-sm transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-white leading-none mb-1 text-sm sm:text-base">AiCare Assistant</h4>
